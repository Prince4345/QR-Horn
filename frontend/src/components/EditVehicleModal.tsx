  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
      ...
      >
        ...
        <p className="text-white/50 text-sm mb-6">Update name, plate, or pause public contact.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full p-4 rounded-2xl border border-white/10 bg-white/5 flex items-center justify-between text-left"
          >
            <div>
            ...
            <div className={`w-12 h-6 rounded-full relative shrink-0 transition-colors ${active ? 'bg-emerald-500' : 'bg-white/10'}`}>
          ...
          <button
            ...
            className="w-full py-3 bg-red-600/20 border border-red-500/30 text-red-300 disabled:opacity-50 rounded-2xl font-semibold flex items-center justify-center gap-2"
          >
