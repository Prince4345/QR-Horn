...
export default function ChatPanel({
 ...
 mobile || desktop ? 'min-h-0' : compact ? 'min-h-[320px]' : 'min-h-[420px]'
    ...
    >
      {readOnlyBanner && (
        <div className="mb-3 p-3 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-800 text-xs">
          {readOnlyBanner}
        </div>
      )}
 ...
 : 'bg-soft text-slate-100 rounded-bl-md'
 }`}
              >
 ...
 mobile || desktop ? 'whitespace-nowrap' : ''
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="min-w-[44px] px-3 rounded-xl bg-brand hover:bg-brand-dark disabled:opacity-50 flex items-center justify-center transition-colors"
